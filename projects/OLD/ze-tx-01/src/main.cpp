...
static uint16_t prepare_packet(uint8_t *packet_ptr, uint8_t* eui48_address, uint32_t packet_counter, uint8_t tx_mode, uint8_t tx_counter, uint8_t csma_retries, int8_t csma_rssi);
